...
#Question Set Up
#How does TypeofContact influence Numbers of Visistors per trip  
##and number of Trips among customers who made a purchase?
...
### Since there is only 1 of 19 and 20 trips, 
### we are removing these values.
...
###p-value < 1.934e-12 --> significant -> violate assumption.
...
#P-value of 0.3947 > 0.05 means this is not a significant. --> pass the assumption

##Asence of multicollinearity.
cor.test(ProdTrip$NumberOfPersonVisitingSquare, ProdTrip$NumberOfTripsLOG, 
         method="pearson", use="complete.obs")
#Finally an assumption you have met! With a correlation of r = .27 < 0.7, 
##you have an absence of multicollinearity.

##The Analysis
MANOVA <- manova(cbind(NumberOfPersonVisitingSquare, NumberOfTripsLOG) ~ 
                   TypeofContact,data = ProdTrip)
summary(MANOVA)
...
###NumberOfPersonVisiting Pr(>F) value of 0.2328 is not significant.
###NumberOfTrips Pr(>F) value of 0.03349 is significant.
...
##ANOVAs as Post Hocs
summary.aov(MANOVAP, test = "wilks") 
